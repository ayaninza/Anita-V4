...
global.anitav4 = process.env.BOT_NAME || "QUEEN_ALYA_V4";
global.ownername = process.env.OWNER_NAME || "A L Y A";
global.packname = process.env.PACK_NAME || "𝐐𝐔𝐄𝐄𝐍_𝐀𝐍𝐈𝐓𝐀-𝐕𝟒";
global.author = process.env.AUTHOR || "A L Y A";
global.channelname = process.env.CHANNEL_NAME || "A L Y A";
